...
def test(cfg,
    ...
    if dataloader is None:
        dataset = LoadImagesAndLabels(path, imgsz, batch_size, rect=True, single_cls=False, pad=0.5)
...
#              opt.single_cls,
#              opt.augment)
         test(model = model, cfg=opt.cfg, data=opt.data,batch_size=opt.batch_size, imgsz=img_size,is_training = False)
